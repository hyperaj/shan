...
def first_page(_):
	controll_button = [InlineKeyboardButton(text="◁", callback_data=f"ThavaX2"), InlineKeyboardButton(text="🦋 ʙᴀᴄᴋ 🤍", callback_data=f"settingsback_helper"), InlineKeyboardButton(text="▷", callback_data=f"ThavaX1")]
