...
from ThavaXMusic.plugins.tools.pretenderdb import impo_off, impo_on, check_pretender, add_userdata, get_userdata, usr_data
...
ROY = [
    [
        ...
        InlineKeyboardButton(text="ᴜᴘᴅᴀᴛᴇ", url=f"https://t.me/Team_Hypers_Networks")
    ],
]
